// src/supabase-staging.js
// SALINAN untuk STAGING - isi 2 baris di bawah dengan URL & anon key
// project Supabase STAGING Anda (LIHAT STAGING-SETUP.md), lalu jalankan:
//   cp src/supabase-staging.js src/supabase.js
// SEBELUM build+deploy ke staging (mirip cara wrangler-staging.toml
// dipakai). JANGAN LUPA kembalikan src/supabase.js ke versi produksi
// (git checkout / salinan cadangan) sebelum deploy ke produksi lagi.
import { createClient } from 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm';

const supabaseUrl = 'GANTI-DENGAN-URL-PROJECT-STAGING'; // contoh: https://xxxxx.supabase.co
const supabaseAnonKey = 'GANTI-DENGAN-ANON-KEY-PROJECT-STAGING';
